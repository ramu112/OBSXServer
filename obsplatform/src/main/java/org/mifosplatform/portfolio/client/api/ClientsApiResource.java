...
public class ClientsApiResource {
	...
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces({MediaType.APPLICATION_JSON})
	public String retriveSearchClient(@Context final UriInfo uriInfo ,@PathParam("columnName") final String columnName,@QueryParam("columnValue") final String columnValue){
