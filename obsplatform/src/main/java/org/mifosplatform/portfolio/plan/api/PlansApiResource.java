...
//Response Data parameters
	private static final Set<String> RESPONSE_DATA_PARAMETERS = new HashSet<String>(Arrays.asList("id", "planCode", "plan_description", "startDate","isHwReq",
            ...
            "service_type", "charge_type", "allowedtypes","selectedservice","bill_rule","billiingcycle","servicedata","services","statusname","planstatus","volumeTypes","planType"));
	...
	private PlanData handleTemplateData(PlanData planData) {
		 ...
		 final List<ServiceData> data = this.serviceMasterReadPlatformService.retriveServices("P");
		 ...
		 final Collection<MCodeData> planTypeData = this.mCodeReadPlatformService.getCodeValue(CodeNameConstants.PLAN_TYPE);
		 ...
		 return new PlanData(data, billData, null,status, planData, services,provisionSysData,volumeType,planTypeData);
