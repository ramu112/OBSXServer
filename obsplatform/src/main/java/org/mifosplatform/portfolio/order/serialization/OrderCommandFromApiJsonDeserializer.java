...
public final class OrderCommandFromApiJsonDeserializer {
    ...
    private final Set<String> supportedParameters = new HashSet<String>(Arrays.asList("planCode","locale","dateFormat","start_date","paytermCode",
    		...
    		"suspensionDescription","status","actionType","priceId","autoRenew","planId","duration","planDescription","serialnumber","allocation_type","orderId","clientServiceId"));
    private final Set<String> retracksupportedParameters = new HashSet<String>(Arrays.asList("commandName","message","orderId","clientServiceId"));
