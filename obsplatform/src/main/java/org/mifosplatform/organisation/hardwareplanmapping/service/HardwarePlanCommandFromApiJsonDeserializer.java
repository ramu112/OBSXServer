...
public final class HardwarePlanCommandFromApiJsonDeserializer {
	 ...
	 */
	private final Set<String> supportedParameters = new HashSet<String>(Arrays.asList("id", "planCode", "itemCode","provisioningId"));
	...
	public void validateForCreate(final String json) {
		...
		final Long provisioningId = fromApiJsonHelper.extractLongNamed("provisioningId", element);
