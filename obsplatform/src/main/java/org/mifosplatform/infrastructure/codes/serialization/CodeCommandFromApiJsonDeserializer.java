...
public final class CodeCommandFromApiJsonDeserializer {
     ...
     */
    private final Set<String> supportedParameters = new HashSet<String>(Arrays.asList("name","description","module"));
    ...
    public void validateForCreate(final String json) {
    	...
    	final String module = fromApiJsonHelper.extractStringNamed("module", element);
        baseDataValidator.reset().parameter("module").value(module).notBlank().notExceedingLengthOf(15);
