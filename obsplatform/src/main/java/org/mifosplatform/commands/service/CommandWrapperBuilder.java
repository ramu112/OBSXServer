...
public class CommandWrapperBuilder {
	...
	public CommandWrapperBuilder createSimpleActivation() {
		...
		this.href = "/activationprocess/template";
		return this;
	...
	public CommandWrapperBuilder createClientServiceActivation(Long clientServiceId) {
		...
		this.href = "/clientservice/"+clientId+"/"+clientServiceId;
		return this;
	}
	...
	public CommandWrapperBuilder updateChannelMapping(Long channelMappingId) {
		this.actionName = "UPDATE";
		this.entityName = "CHANNELMAPPING";
		this.entityId = channelMappingId; 
		this.href = "/channelmapping/"+channelMappingId;
		return this;
	}
